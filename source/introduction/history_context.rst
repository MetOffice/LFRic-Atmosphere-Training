...
LFRic Atmosphere uses the same terrain-following vertical coordinates as the Unified Model but has a cubed sphere mesh, a new mixed finite-element dynamical core, GungHo, and a new coding infrastructure. The cubed sphere mesh avoids the pole singularity problem of lon/lat grids which prohibits scaling the Unified Model to km scale global grids. The coding infrastructure separates details of code parallelisation from the mathematical formulation of physical representation of the atmosphere. This separation of concerns allows for easier optimisation of the same model code for different compute platforms.
