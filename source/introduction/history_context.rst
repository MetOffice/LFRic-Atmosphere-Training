...
Like the Unified Model, LFRic Atmosphere uses terrain-following vertical coordinates, so model levels (two-dimensional horizontal slices of the atmosphere) follow the shape of the lower boundary near the surface.
