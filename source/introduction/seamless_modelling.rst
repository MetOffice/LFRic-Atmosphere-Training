...
Where possible, the same underlying equations of motion (known as the dynamical core) and the same representations of physical processes, such as clouds, radiation, and turbulence (known as parameterisations), are used across different model configurations. 
