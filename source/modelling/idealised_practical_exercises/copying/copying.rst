...
To begin working with the idealised suite, you first need
to create your own copy of an existing workflow.

As introduced in the *Global Modelling Practical* and repeated
in the *Regional Modelling Practical*, you can do this
using the ``rose`` command-line tool.
...
For this hands-on exercise, go ahead and **copy the workflow**,
just as you did in the previous practicals.
