...
.. admonition:: Example from previous studies: changing the water vapour profile
   ...
   LFRic allows us to repeat their experiments by changing the background composition (gas constants) and the initial profile of water vapour.
   Talk to Alex Corbett if you are interested.

.. Note:: If you decide to test your own experiment with a code or configuration change, be ready to do lots of debugging! If you want an example which is tried and tested, use the suggested examples above.
