...
.. code-block:: ini
    ...
    [namelist:planet] cp=1005.0 gravity=9.81 omega=7.292116E-5 p_zero=100000.0
    rd=287.05 scaling_factor=1.0
...
.. code-block:: ini
    ...
    [namelist:initial_vapour] profile_data=0.5,0.5,0.0,0.0
    profile_heights=0,18638,24863,75000 profile_size=4 profile_variable='mr'
