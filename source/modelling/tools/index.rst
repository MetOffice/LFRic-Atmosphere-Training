...
Numerical weather prediction (NWP) and climate models have a large numbers of jobs which are executed at regular intervals to process new data and generate new predictions and projections. Dependencies between these cycles creates a single never-ending workflow, which NWP workflow schedulers have traditionally ignored.
