...
``u-by395``, for a global workflow example please use ``u-dz612``.

You can copy or checkout an existing workflow using the rose command-line tool, replacing ``u-dz612`` with
