...
In this experiment, you will halve the rotation rate of the Earth to
observe
...
2. Search for the ``omega`` key (located under the
   ``[namelist:planet]``
   section).
...
Now that you have halved the rotation rate of the Earth, run the
model using
what you have learnt in the previous exercises. After the model has
completed,
check the output files to observe the impact of the halved rotation
rate on
the model climate. You can use tools like ``ncdump``, ``xconv``, or
``python`` to inspect
